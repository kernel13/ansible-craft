...
describe('runPlaybookWizard', () => {
  ...
  test('result is validated by Zod schema', async () => {
    mockInput.mockResolvedValueOnce('databases').mockResolvedValueOnce(''); // no handlers
  ...
  test('calls prompts in correct order', async () => {
    mockInput.mockResolvedValueOnce('webservers').mockResolvedValueOnce('');
  ...
  test('hosts array contains single element', async () => {
    mockInput.mockResolvedValueOnce('web*:&staging').mockResolvedValueOnce('');
  ...
  test('includeHandlers is true when description provided', async () => {
    mockInput.mockResolvedValueOnce('webservers').mockResolvedValueOnce('restart nginx');
  ...
  test('includeHandlers is false when no description', async () => {
    mockInput.mockResolvedValueOnce('webservers').mockResolvedValueOnce(''); // empty handlers
  ...
  test('custom contains handlersDescription when provided', async () => {
    mockInput.mockResolvedValueOnce('webservers').mockResolvedValueOnce('restart nginx'); // handlers
